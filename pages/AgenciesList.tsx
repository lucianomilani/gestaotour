...
const initialAgencies: Agency[] = [
  { id: '1', code: 'AGT001', name: 'Viagens Norte', nif: '501234567', email: 'reservas@viagensnorte.pt', phone: '912345678', contact: 'Ana Silva', isActive: true },
  { id: '2', code: 'AGT002', name: 'GetYourGuide', nif: '987654321', email: 'partners@getyourguide.com', phone: '+351 210 000 000', contact: 'Support Team', isActive: true },
  { id: '3', code: 'AGT003', name: 'Airbnb Experiences', nif: '505555555', email: 'experiences@airbnb.com', phone: 'N/A', contact: 'Digital Portal', isActive: true },
  { id: '4', code: 'AGT004', name: 'Booking.com', nif: '509999999', email: 'partners@booking.com', phone: '+31 20 712 5600', contact: 'Partner Support', isActive: true },
  { id: '5', code: 'AGT005', name: 'MLTours', nif: '502223334', email: 'lmilani.mail@gmail.com', phone: '966666666', contact: 'Luciano Milani', isActive: false },
];
...
export const AgenciesList: React.FC = () => {
  ...
  const filteredAgencies = agencies.filter(agency => {
    const matchesSearch = agency.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
                          ...
                          agency.nif.includes(searchTerm);
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (modalMode === 'add') {
        ...
        setAgencies([...agencies, { ...currentAgency, id }]);
    } else {
        // Edit Mode
                ...
                <form onSubmit={handleSubmit} className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <input 
                            ...
                            className={baseInputClass} placeholder="Ex: Viagens Norte"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            className={baseInputClass} placeholder="123456789"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            className={baseInputClass} placeholder="geral@agencia.com"
                        />
                    </div>
                    ...
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <input 
                            ...
                            className={baseInputClass} placeholder="Ex: Ana Silva"
                        />
                    </div>
