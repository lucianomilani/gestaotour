...
export const Dashboard: React.FC = () => {
      ...
      try {
        ...
        if (bookings) {
          ...
          const recent = activeBookings.slice(0, 5).map(b => ({
            ...
            duration: b.adventure?.duration || 'N/A',
  ...
  const getDayContent = (day: number) => {
    ...
    const bookingsOnDate = recentBookings.filter(b => b.startDate === dateStr).length;
              ...
              {recentBookings.length > 0 ? (
                recentBookings.map((booking) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-gray-600 dark:text-gray-300">{booking.duration}</td>
