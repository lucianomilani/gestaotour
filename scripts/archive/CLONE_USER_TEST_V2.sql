-- ============================================================
-- TESTE DE CLONAGEM V2: Corrigido (Sem colunas inexistentes)
-- ============================================================

DO $$
DECLARE
    source_email text := 'manual@teste.com';
    target_email text := 'clone2@teste.com';
...
BEGIN
    ...
    -- 2. Inserir clone em auth.users (Removido control_token)
    INSERT INTO auth.users (
        ...
        confirmed_at,
        recovery_token,
        -- control_token removido
        -- email_change_token_new removido (por precaução)
        email_change,
        phone,
        phone_change,
        phone_change_token,
        -- email_change_token_current removido (por precaução)
        ...
        source_user.role,
        target_email,
        source_user.encrypted_password,
        now(),
        now(),
        source_user.recovery_token,
        -- source_user.control_token,
        -- source_user.email_change_token_new,
        source_user.email_change,
        null,
        source_user.phone_change,
        source_user.phone_change_token,
        -- source_user.email_change_token_current,
