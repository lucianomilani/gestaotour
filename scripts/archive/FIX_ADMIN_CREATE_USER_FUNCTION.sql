-- ============================================================
-- FIX: Corrigir função admin_create_user
-- ============================================================
-- Este script corrige o erro de ambiguidade na função
-- Execute no Supabase SQL Editor
-- ============================================================

-- Recreate the function with the ambiguity fix
...
BEGIN
  ...
  -- Check if user exists in staff and has permissions (FIXED: Added table alias 's')
