-- ============================================================
-- FIX FINAL V2: Função admin_create_user (Correção Login)
-- ============================================================
-- Correções adicionais:
-- 1. Define 'confirmed_at' (além de email_confirmed_at)
-- 2. Usa custo 10 para hash de senha (padrão Supabase)
-- ============================================================
...
BEGIN
  ...
  -- 3. Generate new UUID and encrypt password (FIX: Cost 10)
  ...
  INSERT INTO auth.users (
    ...
    encrypted_password,
    email_confirmed_at,
    confirmed_at,          -- FIX: Added confirmed_at
    raw_app_meta_data,
    raw_user_meta_data,
    created_at,
    updated_at,
    confirmation_token,
    recovery_token,
    is_sso_user            -- FIX: Explicitly set false
  ) VALUES (
