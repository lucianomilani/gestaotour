-- ============================================================
-- FIX V2: Corrigir função admin_create_user (UUID fix)
-- ============================================================
-- Corrige o erro: column "id" is of type uuid but expression is of type text
...
BEGIN
  ...
  -- Check if user exists in staff and has permissions (FIXED: table alias + variable rename)
  ...
  -- 5. Insert into auth.identities (FIXED: use UUID directly, not text cast)
  INSERT INTO auth.identities (
    ...
    gen_random_uuid(),  -- FIXED: Generate a new UUID for identity id
    new_user_id,
