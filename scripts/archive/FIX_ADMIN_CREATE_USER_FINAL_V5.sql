-- ============================================================
-- FIX FINAL V5: Função admin_create_user (Metadata Fix)
-- ============================================================
-- Correção: Adiciona 'email_verified': true em raw_user_meta_data
-- Mantém extensions.crypt e outras correções.
-- ============================================================
...
BEGIN
  ...
  -- 3. Generate new UUID and encrypt password (EXPLICIT EXTENSIONS)
  ...
  INSERT INTO auth.users (
    ...
    jsonb_build_object(
        'name', new_name, 
        'role', new_role,
        'email_verified', true  -- FIX: Added email_verified flag
    ),
    now(),
    now(),
    '',
