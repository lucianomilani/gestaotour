-- ============================================================
-- FIX V3: Corrigir função admin_create_user (provider_id fix)
-- ============================================================
-- Corrige o erro: null value in column "provider_id" violates not-null constraint
...
BEGIN
  ...
  -- 5. Insert into auth.identities (FIXED: added provider_id)
  INSERT INTO auth.identities (
    ...
    gen_random_uuid(),
    new_user_id,
    new_user_id::text,  -- provider_id is the user id as text for email provider
